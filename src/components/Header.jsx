...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >
        Turn text to <span className="text-blue-600">image</span>
        ,in seconds.
      </motion.h1>
      <motion.p
      ...
      >
        Unleash your creativity with AI. Turn your imagination into virtual art
        in seconds - just type, and watch the majic happen.
      </motion.p>
      <motion.button
