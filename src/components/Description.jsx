...
const Description = () => {
  return (
    ...
    >
      <h1 className="text-3xl sm:text4xl font-semibold mb-2 ">
        Create AI images
      </h1>
      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center ">
        ...
        <div className="">
          <h2 className="text-3xl font-medium max-w-lg  mb-4">
            Introducing the AI-PoweredText to Image Generator
          </h2>
          <p className="text-gray-600 mb-4">
            ...
            tool transform to text into eye-catching images with just a few
